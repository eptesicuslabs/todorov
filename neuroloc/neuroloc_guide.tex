...
\textbf{Why this matters for your architecture:} next-token prediction works. But the brain does something more principled: it predicts everything, everywhere, all at once.
...
\textbf{Connect to what you know:} you train with cross-entropy loss on the next token. The brain trains each cortical layer to predict the layer below it. The error signals are local, not global.
