...
the neuroloc wiki maps brain computation mechanisms to todorov's CRBR framework. 61 mechanism articles, 19 bridge documents, 11 synthesis articles, 13 comparisons, 33 entity notes, 21 test records, 2 mistake docs, 40 knowledge articles, 7 concept articles.

start here: [[start_here]]

### quick navigation
- [[index]] -- master catalog of all articles
...
- [[plasticity_to_kda_delta_rule|plasticity -> KDA delta rule]]
...
- [[memory_systems_to_kda_mla|memory systems -> KDA/MLA]]
...
- [[glossary]] -- 55 terms in plain language
